...
export class LogFormatter extends Function {
     ...
     * 是否自动缩进对象输出
     */
    private _indentJson: boolean = false;
     ...
     * 样式层
     */
    private _formatLayer: FormatLayer[] = [];
     ...
     */
    private get _getLastFormatLayerAndSetHasUsed() {
     ...
     */
    line(char: string = '-', length: number = process.stdout.columns || 80): void {
